                ...
                <div className="row align-items-center">
                    <div className="col-md-6 mb-4 mb-md-0">
                        ...
                        <div className="d-flex flex-wrap gap-3" data-aos-duration="1000" data-aos="fade-up">
                            <a href="https://wa.me/6285371650193" target="_blank" rel="noopener noreferrer" className="text-decoration-none" data-aos-delay="1000" data-aos="fade-down">
                            ...
                            <div className="position-relative overflow-hidden rounded">
                                {heroImages.map((image, index) => (
                                    <img
                                        key={index}
                                        src={image}
                                        className={`img-fluid w-100 position-absolute top-0 start-0 ${index === currentSlide ? 'opacity-100' : 'opacity-0'
                                            }`}
